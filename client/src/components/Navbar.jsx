...
const Navbar = () => {
    ...
    const { user, setUser, setShowUserLogin, setSearchQuery, searchQuery, getCartCount, axios, setCartItems } = useAppContext()
                ...
                <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden z-50 flex">
                    ...
                    {!user ? (
                        ...
                        <button
                            ...
                            className="cursor-pointer px-6 py-2 mt-2 bg-indigo-500 hover:bg-red-600 transition text-white rounded-full text-sm"
                        >
                            Logout
                        </button>
                    )}
