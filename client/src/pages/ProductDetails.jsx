...
const ProductDetails = () => {
    ...
    // Get related products when products or product changes
    useEffect(() => {
    ...
    return (
        <div className="mt-12">
            ...
            <p>
                ...
                /<span className="text-indigo-primary"> {product.name}</span>
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                    ...
                    <div className="flex flex-col gap-3">
                        {product.images.map((image, index) => (
                            <div
                                ...
                                className="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer hover:border-primary"
                            >
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        ...
                        <p className="text-base ml-2">({displayRating})</p>
                    </div>
